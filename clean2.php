...
<form method="GET" name="frmsearch" onsumit="return checkval(); return false;">
	<ul style="list-style-type:none">
		<li>Select type of searching: <input type="radio" name="type" value="file" <?php echo $_GET['type']=='file' ? 'CHECKED':''; ?>>&nbsp;Filename 
			&nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="content" <?php echo $_GET['type']=='content' ? 'CHECKED':''; ?>>&nbsp;Content
		</li>
		<li><input type="text" name="keyword" value="<?php echo $_REQUEST['keyword']; ?>"></li>
